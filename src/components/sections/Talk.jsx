...
function Talk() {
  return (
    <div className="h-max w-full flex flex-col py-10 md:py-0 justify-center items-center bg-white relative z-50">
      <div className="w-11/12 sm:w-10/12 flex flex-col justify-center items-center gap-10 h-max">
          ...
          <div className="flex flex-col justify-center items-center">
            <div className="flex flex-col justify-center items-start w-10/12 gap-4">
              ...
              <p className="text-sm text-black/80 text-center md:text-left">
                ...
                backbone for internet-based ventures. Simplify purchases,
                enhance security, and unlock new possibilities in the digital
                realm. Stay tuned for a game-changing addition to your online
                financial toolkit – QuickCash by Palmpay. Your gateway to
                effortless and secure internet business transactions is just
                around the corner.
              </p>
            </div>
          </div>
        ...
        <div className="p-2 flex flex-col-reverse justify-center items-center md:grid md:grid-cols-2 md:place-items-center gap-10 md:gap-6 md:w-11/12 lg:w-10/12 md:mt-[10vh] lg:mt-[15vh] md:mb-[15vh]">
          ...
          <div className="flex flex-col gap-3 md:gap-2 items-center md:items-start">
            ...
            <p className="text-sm text-black/70 text-center md:text-left">
              ...
              experience, offering an efficient and cohesive solution for
              managing finances in one platform.
            </p>
          </div>
        </div>
      </div>
