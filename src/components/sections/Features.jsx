...
function Features() {
  return (
    <div className="bg-black text-white w-full p-4 md:p-8 flex flex-col md:flex-row gap-4">
      <div className="flex flex-col gap-2 p-2 justify-center">
        ...
        <p className="text-xs text-white/50">
          Meet Quick Cash – your solution to banking hassles! Our new debit card
          simplifies your life with instant transactions, fraud protection, and
          24/7 access. Skip the wait, embrace the ease. Quick Cash, making
          banking a breeze!
        </p>
      </div>
