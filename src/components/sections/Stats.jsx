...
function Stats() {
  return (
    <div className="bg-white relative z-50 w-full grid place-items-center py-10 md:py-0 lg:h-[40vh]">
      <div className="bg-gradient-to-br from-primary via-primary/70 to-primary text-white w-full grid place-items-center h-full">
        ...
        <div className="sm:w-10/12 grid md:grid-cols-3">
          <div className="p-8 text-center">
            ...
            <p className="text-sm mt-3 text-white/70">
              Which is approximately 56% of the consumer of finance sector
            </p>
          </div>
          <div className="p-8 text-center">
            <p className="text-3xl font-bold">41%</p>
            <p className="text-sm mt-3 text-white/70">
              Percentage of active users everyday everywhere in Nigeria
            </p>
          </div>
          <div className="p-8 text-center">
